...
import { urlFor } from "../components/ProjectImages";
...
// const Projects: React.FC = () => {
  ...
  return (
    <>
    <div className="fixed overflow-visible top-0 right-0 z-[100]">
      <Categories />
    </div>
                ...
                {expandedPostId === post._id && (
                  ...
                  >
                    ...
                    <Suspense fallback={null}>
                      {post.images && (<img src={urlFor(post.images[0].asset._ref).url()} alt="" className="visible sm:invisible pb-4 sm:h-0"/>)}
                      {/* <motion.div 
    ...
    <AnimatePresence>
    <motion.div className="children-wrapper sm:w-2/3 w-full h-80vh sm:h-[100vh] fixed top-0 right-0 overflow-scroll sm:z-50 z-[80]"
    initial={{ height: 0 }}
    animate={{ height: 'auto' }}
    exit={{ height: 0 }}
    transition={{ duration: 0.5, ease: 'easeOut' }}>
